...
CREATE TABLE IF NOT EXISTS `unf_app_config` (
...
CREATE TABLE IF NOT EXISTS `unf_cicookies` (
...
CREATE TABLE IF NOT EXISTS `unf_ci_sessions` (
...
CREATE TABLE IF NOT EXISTS `unf_country_list` (
...
CREATE TABLE IF NOT EXISTS `unf_main_modules` (
...
CREATE TABLE IF NOT EXISTS `unf_modules` (
  `name_lang_key` varchar(255) NOT NULL,
  `desc_lang_key` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `unf_permissions` (
  `module_id` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `unf_userinfo` (
...
CREATE TABLE IF NOT EXISTS `unf_users` (
...
--
-- Table structure for table `unf_temp`
--

CREATE TABLE IF NOT EXISTS `unf_temp_pass` (
...
--
-- Dumping data for table `unf_temp`
--

INSERT INTO `unf_temp_pass` (`pass`) VALUES ('temp_pass_val');

--
-- Table structure for table `unf_statistics`
--

CREATE TABLE IF NOT EXISTS `unf_statistics` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `unf_email_log` (
  `id` int(11) NOT NULL,
